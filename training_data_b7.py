...
SKILL_LADDER = [
 ...
 ("D — Advanced / Ziele (GETRENNTE Skills!)",
  "FLAG = laterale Seitneigung (aus Huefte, Schulter ueber Hand) -> AKTIV im Training (T4). FIGA = eigener Shape (Arm-Konfig/T-Shape) -> SEPARAT, noch NICHT begonnen. Twist ebenfalls separat.",
  "Flag: saubere Entries -> Hold-Sek + Kontrolle pro Seite. Figa/Twist: eigene Progression, spaeter.",
  "Flag: laeuft (unsup. Lean + Straddle Flag Hold). Figa/Twist: Fernziel, eigenes Setup wenn Basis-Shapes solide.",
  "Flag: Haltezeit hoch + Support runter. Figa: erst starten wenn OAHS-Shapes (Tier A/B) solide"),
]
SKILL_RULES = [
...
PLAN = [
 ...
 ("T1","Handstand-Ausdauer","Chest-to-Wall Handstand-Hold auf ZEIT (Zeit akkumulieren) + optional HS-Shrugs","3-4x30-45s","3-4x40-50s","3-4x45-60s","2x30s","Technik/Qual","60-75s","Gesamtzeit/Session Woche fuer Woche steigern; C2W baut Schulter/Serratus-Ausdauer fuer lange OAHS-Holds; kein random Drill","ribs down, Ellbogen gestreckt","ersetzt vagen Overhead-Hold"),
 ...
 ("T4","Warm-up + Side-Body","Laenger + Side-Body-Aktivierung (Side Plank, QL/Oblique)","1 Block","1","1","1","Qual 4-5","-","vor Flag noetig; Schulter + Side-Body vorbereiten","neutral","Verletzungsschutz"),
 ("T4","Flag-Ramp","Supported/2-arm Flag-Position (Hip-Drop grooven) + leichter unsup. Lean","2-3/Seite","2-3","2-3","beste","Qual 4-5","60-90s","Schulter UEBER Hand, Seitneigung aus HUEFTE, nicht hetzen (kein Arbeitssatz, nur reintasten)","kontrolliert","in die Position tasten"),
 ("T4","Skill Flag","Unsupported Flag-Lean (Hip-Drop) + kontrollierter Return","4/Seite","4-5","4-5","beste","Qual 4-5","90s","Kontrolle VOR Zeit; Metrik: saubere Entries/Seite loggen; RECHTS +1","kontrolliert","Flag-Pfad"),
 ("T4","Skill Flag","Straddle Flag Hold (seitgeneigt, 1-3s Freeze) + kontrollierter Return","3/Seite","3-4","4","beste","Qual 4-5","90s","Hold-Sek loggen; Support nur senken wenn Re-Entry sauber","kontrollierter Return","seltene freie Versuche"),
 ("T4","Side-Body Kraft","Side Plank (lang/beschwert) / Copenhagen","2-3x30-45s/Seite","2-3","2-3","2","RPE 7","45-60s","Lateral-Kraft = Kraft-Unterbau des Flags (Lats/Obliques/QL)","neutral","Flag-Basis"),
